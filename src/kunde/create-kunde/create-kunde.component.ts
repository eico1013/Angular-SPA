...
import {Name} from '@angular/platform-browser';
...
@Component({
    ...
    templateUrl: './kunden/create-kunde/create-kunde.component.html'
})
export default class CreateKundeComponent implements OnInit {
    ...
    readonly name: FormControl = new FormControl(
        null, [Validators.required as any, KundeValidator.name]);
    ...
    ngOnInit(): void {
        ...
        this.nameService.setName('Neuer Kunde');
    }
