 ...
 *  <li><code>my-gefundene-kunden</code>
...
export default class SuchergebnisComponent implements OnInit {
    // Im ganzen Beispiel: lokale Speicherung des Zustands und nicht durch
    // z.B.
    ...
    // Weitere Methoden zum Lifecycle: ngAfterViewInit(),
    // ngAfterContentInit()
    // https://angular.io/docs/ts/latest/guide/cheatsheet.html
    // Die Ableitung vom Interface OnInit ist nicht notwendig, aber
    // erleichtet
    ...
    /**
     * Methode, um den injizierten <code>KundenService</code> zu beobachten,
     * ob es bei der Suche Fehler gibt, die in der Kindkomponente f&uuml;r
     * das
     * Tag <code>error-message</code> dargestellt werden. Diese private
     * Methode
