    ...
    template: `
        <div *ngIf="isLoggedIn">
            ...
            <div class="col-xs-2">
                ...
                <button class="btn btn-primary btn-sm ml-1" type="button"
                        (click)="onLogout()">
                    Logout
                </button>
            </div>
...
export default class Logout2Component implements OnInit {
    isLoggedIn: boolean;

    constructor(
        private readonly router: Router,
        private readonly iamService: IamService) {
        console.log('Logout2Component.constructor()');
    }
